 ...
 function Attform() {
  ...
  const handleInputChange = (e) => {
    ...
    setRowData((prevData) => ({
      ...prevData,
      [name]: value,
      TotalPrice: name === 'Quantity' || name === 'UnitPrice' ? value * prevData.UnitPrice : prevData.TotalPrice,
    }));
  };
                ...
                <form className="well form-horizontal" action=" " method="post" id="Invoice02">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      readOnly // Make TotalPrice field read-only
                    />
                  </div>
                </form>
                <button type="submit" className="btn btn-primary mb-2" onClick={() => { Invoice2sub(); handleAddRow(); }}>
                  Submit
                </button>
              </div>
            </div>
